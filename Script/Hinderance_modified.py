...
#path = 'C:/Users/2000r/Downloads/Final_data/Final_data/000cf80f9ff74db95a46cd3a269a6e7c.png'
path=''
n = -1
hinderance = []
global img
...
def main():
    ...
    for i in range(n):
        ...
        x = x + depletion[hinderance_id-1] *dist
        y = y + depletion[hinderance_id-1] *dist
        if int(x) >(img.shape[0] -7) or int(y) > (img.shape[1] - 7):
            x = o_x
            y = o_y
